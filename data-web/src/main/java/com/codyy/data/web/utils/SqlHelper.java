...
public class SqlHelper {
     ...
     * @return
     */
//    public static String getMapperSqlByBrifMethod(Object mapper, String methodName, Object... args) {
...
//    }
     ...
     * @return
     */
//    public static String getMapperSqlByFullMethod(SqlSession session, String fullMapperMethodName, Object... args) {
//        if (args == null || args.length == 0) {
...
//    }
     ...
     */
    public static String getNamespaceSqlNoParameter(SqlSession session, String namespace) {
...
//    public static String getMapperSql(SqlSession session, @SuppressWarnings("rawtypes") Class mapperInterface, String methodName, Object... args) {
//        String fullMapperMethodName = mapperInterface.getCanonicalName() + "." + methodName;
//        if (args == null || args.length == 0) {
//            return getNamespaceSql(session, fullMapperMethodName, null);
//        }
...
//    }
     ...
     * @return
     */
//    public static String getNamespaceSqlNoParam(SqlSession session, String namespace) {
//        return getNamespaceSql(session, namespace, null);
//    }
...
//    }
     ...
     * @return
     */
    private static Method getDeclaredMethods(@SuppressWarnings("rawtypes") Class clazz, String methodName) {
        Method[] methods = clazz.getDeclaredMethods();
        for (Method method : methods) {
            if (method.getName().equals(methodName)) {
                return method;
